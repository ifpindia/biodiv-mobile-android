...
public class ObservationDetailActivity extends ActionBarActivity{
	...
	public class ImagePagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View collection,final int position) {
		    ...
		    if(resource.get(position).getUrl()!=null)
		    	MImageLoader.displayImage(context, resource.get(position).getUrl(), (ImageView) layout.findViewById(R.id.myimage), R.drawable.user_stub);
		    
		    ((ImageView) layout.findViewById(R.id.myimage)).setOnClickListener(new View.OnClickListener() {
				
				@Override
				public void onClick(View v) {
					showImageDialog(context, resource.get(position).getIcon());
				}
			});
	...
	private void showImageDialog(Context context, String url) {
		...
		MImageLoader.displayImage(context, url.replace("_th1.jpg", ".jpg"), ((ImageView)settingsDialog.findViewById(R.id.image)), R.drawable.user_stub);
